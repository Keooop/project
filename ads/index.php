...
?>
 ...
 <?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"DETAIL_PROPERTY_CODE" => array(0=>"LINK",1=>"GARAGES",2=>"SQUARE",3=>"PRIORITY",4=>"BATH",5=>"PRICE",6=>"BEDROOM",7=>"DOCUMENT",8=>"",),
		...
		"LIST_PROPERTY_CODE" => array(0=>"LINK",1=>"GARAGES",2=>"SQUARE",3=>"PRIORITY",4=>"BATH",5=>"PRICE",6=>"BEDROOM",7=>"DOCUMENT",8=>"",),
		"MESSAGE_404" => "",
		"META_DESCRIPTION" => "-",
		"META_KEYWORDS" => "-",
		"NEWS_COUNT" => "3",
		...
		"SEF_FOLDER" => "/ads/",
		"SEF_MODE" => "Y",
		"SEF_URL_TEMPLATES" => array("news"=>"ads/","section"=>"","detail"=>"#ELEMENT_CODE#/",),
		"SET_LAST_MODIFIED" => "Y",
		"SET_STATUS_404" => "N",
		"SET_TITLE" => "Y",
		"SHOW_404" => "N",
